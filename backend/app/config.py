...
class Settings(BaseSettings):
    ...
    # Infra. Connect as the non-superuser rotaai_app role so Row-Level Security
    # applies to the app (a superuser would bypass it — see db/init/01_schema.sql).
    database_url: str = "postgresql+psycopg2://rotaai_app:rotaai_app@db:5432/rotaai"
